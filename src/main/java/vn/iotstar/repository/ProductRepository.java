...
public interface ProductRepository extends JpaRepository<Product, Long> {
	 ...
	 */
	 ...
	 Page<Product> findAll(Pageable pageable); // Các truy vấn khác như: new arrivals, best sellers, etc.
	 ...
	 "GROUP BY p.id") Page<Object[]> findByCategoryIdAndStatusWithAvgRating(Long
	 categoryId, int status, Pageable pageable);
